...
INSERT INTO ATIVIDADES (ID_ATIVIDADE, NOME_ATV, DATA_ATV, HORA_ATV, EVENTO_ATV) VALUES
    ...
    (7, 'Desfile Outono/Inverno', '2025-02-28', '16:00:00', 2),
    (8, 'Degustação de Orgânicos', '2025-05-15', '10:30:00', 8),
    (9, 'Exibição de Dispositivos Inteligentes', '2025-07-20', '14:30:00', 9),
    (10, 'Palestra sobre Conservação Marinha', '2025-09-30', '11:30:00', 10),
    (11, 'Workshop de Robótica', '2025-11-10', '13:30:00', 1),
    (12, 'Desfile de Moda Inverno', '2026-01-25', '17:00:00', 2),
    (13, 'Degustação de Vinhos Premiados', '2026-03-05', '10:00:00', 8),
    (14, 'Apresentação de Tecnologias Emergentes', '2026-05-10', '14:00:00', 6),
    (15, 'Palestra sobre Preservação de Tubarões', '2026-07-20', '11:00:00', 10),
    (16, 'Oficina de Robótica para Iniciantes', '2026-09-30', '15:00:00', 4),
    (17, 'Desfile de Moda Outono', '2026-11-10', '16:30:00', 7),
    (18, 'Workshop de Confeitaria', '2027-02-15', '09:00:00', 3),
    (19, 'Apresentação de Novos Gadgets', '2027-04-30', '13:00:00', 4),
    (20, 'Palestra sobre Ecossistemas Marinhos', '2027-06-20', '10:30:00', 10),
    (21, 'Palestra sobre Inteligência Artificial', '2027-08-10', '15:30:00', 6),
    (22, 'Oficina de Desenvolvimento Web', '2027-10-25', '11:00:00', 6),
    (23, 'Desfile de Moda Primavera', '2028-01-15', '14:30:00', 2),
    (24, 'Workshop de Fotografia', '2028-03-20', '10:00:00', 10),
    (25, 'Apresentação de Novas Tendências em Alimentação', '2028-06-05', '12:00:00', 8),
    (26, 'Palestra sobre Sustentabilidade', '2028-08-30', '09:30:00', 8),
    (27, 'Oficina de Design de Interiores', '2028-11-15', '16:00:00', 5),
    (28, 'Desfile de Moda Verão', '2029-02-10', '13:30:00', 2),
    (29, 'Workshop de Marketing Digital', '2029-05-05', '10:30:00', 1),
    (30, 'Palestra sobre Inovação em Tecnologia', '2029-08-20', '15:00:00', 1);
